...
{id:"resume",name:"AI Resume Builder",icon:"💼",desc:"ATS-optimized resumes that land interviews",color:"#f97316",label:"Describe your experience",ph:"e.g., 'Software developer, 5yr, Python, React'",tpl:["Software Engineer","Marketing Manager","Fresh graduate","Career change"],pr:i=>`You are a professional resume writer. ATS-optimized resume for: ${i}\n\n**[NAME]**\n[City] | [Email] | [Phone]\n\n**PROFESSIONAL SUMMARY**\n(3 lines, keyword-rich)\n\n**WORK EXPERIENCE**\n**[Title] — [Company]** *[Dates]*\n• Action verb + metrics bullets\n\n**SKILLS** | **EDUCATION** | **CERTIFICATIONS**`,type:"text"},
{id:"document",name:"AI Document Writer",icon:"📄",desc:"Reports, proposals, SOPs — professional docs",color:"#0ea5e9",label:"What document do you need?",ph:"e.g., 'Business proposal for app development'",tpl:["Business proposal","Project report","SOP document","Company policy"],pr:i=>`You are a professional business writer. Create comprehensive document for: ${i}\n\nUse: proper title, sections, executive summary, detailed body, conclusion and next steps. Min 800 words.`,type:"text"},
{id:"data",name:"AI Data Analyzer",icon:"📊",desc:"Analyze data & find actionable insights",color:"#a855f7",label:"What data to analyze?",ph:"e.g., 'Sales: Q1=$50K Q2=$65K Q3=$45K Q4=$80K'",tpl:["Sales trend analysis","Customer behavior","Financial review","Survey results"],pr:i=>`You are a senior data analyst. Analyze: ${i}\n\n**📊 KEY METRICS** table\n**📈 TRENDS** (3-5 key patterns)\n**📉 RECOMMENDED CHARTS** (describe 3)\n**⚠️ ANOMALIES**\n**💡 RECOMMENDATIONS**\n**🔮 FORECAST**`,type:"text"},
...
{id:"presentation",name:"AI Presentation Maker",icon:"🎯",desc:"Slide decks with speaker notes",color:"#84cc16",label:"What's the presentation about?",ph:"e.g., 'Investor pitch for AI fitness app'",tpl:["Investor pitch deck","Sales presentation","Training workshop","Business review"],pr:i=>`You are a presentation expert. Create 12 slides for: ${i}\n\nEach slide:\n**SLIDE [N]: [TITLE]**\n📊 Visual suggestion\n**Points:** 3 bullets\n🎤 **Speaker Notes:** what to say`,type:"text"},
{id:"legal",name:"AI Legal Draft",icon:"⚖️",desc:"Contracts, NDAs, legal templates",color:"#78716c",label:"What legal document?",ph:"e.g., 'Freelance contract, $5000 project, 6 weeks'",tpl:["Freelance contract","NDA agreement","Terms of service","Privacy policy"],pr:i=>`You are a legal document specialist. Draft for: ${i}\n\nInclude: numbered clauses, definitions, obligations, payment terms, termination, dispute resolution.\n\n⚠️ DISCLAIMER: Template only. Review with qualified attorney.`,type:"text"},
{id:"invoice",name:"AI Invoice Generator",icon:"🧾",desc:"Professional invoices ready to send",color:"#22c55e",label:"Invoice details?",ph:"e.g., '3 logos at $200 each for ABC Corp'",tpl:["Freelance services","Product sales","Consulting hours","Monthly retainer"],pr:i=>`You are a professional accountant. Create invoice for: ${i}\n\n**INVOICE #** INV-${Date.now().toString().slice(-6)}\n**Date:** ${new Date().toLocaleDateString('en-US',{year:'numeric',month:'long',day:'numeric'})}\n\nFROM: [Your details]\nBILL TO: [Client]\n\n| # | Description | Qty | Rate | Amount |\n\nSubtotal, Tax, TOTAL DUE, Payment Terms`,type:"text"},
{id:"grammar",name:"AI Grammar & Rewriter",icon:"🔤",desc:"Fix grammar, rewrite for any tone",color:"#0891b2",label:"What needs fixing?",ph:"e.g., 'Fix: Dear sir i want to apply for job...'",tpl:["Fix my email grammar","Rewrite formally","Make it casual","Simplify complex text"],pr:i=>`You are an expert editor. For: "${i}"\n\n**✅ CORRECTED VERSION:**\n**🎯 PROFESSIONAL VERSION:**\n**💬 CASUAL VERSION:**\n**📝 IMPROVEMENTS MADE:**`,type:"text"},
...
{id:"businessplan",name:"AI Business Plan",icon:"📑",desc:"Complete business plans for investors",color:"#4f46e5",label:"Describe your business idea",ph:"e.g., 'Online tutoring platform for high school students'",tpl:["Startup plan","Restaurant plan","E-commerce plan","SaaS plan"],pr:i=>`You are a business consultant. Write business plan for: ${i}\n\n**1. EXECUTIVE SUMMARY**\n**2. MARKET ANALYSIS**\n**3. PRODUCTS/SERVICES**\n**4. MARKETING STRATEGY**\n**5. FINANCIAL PROJECTIONS**\n| Year | Revenue | Expenses | Profit |\n**6. FUNDING REQUIREMENTS**`,type:"text"},
{id:"coverletter",name:"AI Cover Letter",icon:"📩",desc:"Job-winning cover letters for any position",color:"#0284c7",label:"Job + your background",ph:"e.g., 'Applying for Senior Developer at Google, 5yr Python'",tpl:["Software Engineer","Marketing Manager","Fresh graduate","Career change"],pr:i=>`You are a career coach. Write cover letter for: ${i}\n\nFormat: hook opening, 2-3 achievement paragraphs with metrics, why this company, strong CTA closing. Professional tone.`,type:"text"},
...
{id:"pressrelease",name:"AI Press Release",icon:"📰",desc:"Professional press releases for media",color:"#1d4ed8",label:"What's the announcement?",ph:"e.g., 'Launching AI tools platform'",tpl:["Product launch","Partnership news","Funding announcement","Award"],pr:i=>`You are a PR expert. Write press release for: ${i}\n\n**FOR IMMEDIATE RELEASE**\n**[HEADLINE]**\n**[SUBHEADLINE]**\n\n[Opening paragraph: who, what, when, where, why]\n[Body + quote from founder]\n[Company boilerplate]\n\n**MEDIA CONTACT:**\n###`,type:"text"},
...
{id:"studyguide",name:"AI Study Guide",icon:"📚",desc:"Turn any topic into study materials",color:"#7e22ce",label:"What to study?",ph:"e.g., 'Machine learning basics for beginners'",tpl:["Exam prep","Concept explainer","Practice questions","Study schedule"],pr:i=>`You are a master educator. Study guide for: ${i}\n\n**📋 CORE CONCEPTS:**\n**🧠 MEMORY AIDS:**\n**✅ PRACTICE QUESTIONS (10):**\n**📝 CHEAT SHEET:**\n**📅 7-DAY STUDY PLAN:**`,type:"text"},
...
{id:"jobdescription",name:"AI Job Description",icon:"👔",desc:"Attract top talent with compelling job posts",color:"#155e75",label:"What role are you hiring for?",ph:"e.g., 'Senior React Developer, remote, $80-100K'",tpl:["Software Developer","Marketing Manager","Customer Support","Sales Executive"],pr:i=>`You are an HR expert. Job description for: ${i}\n\n**[JOB TITLE]**\n📍 Location | 💰 Salary | ⏰ Type\n\n**ABOUT THE ROLE:**\n**RESPONSIBILITIES:**\n**REQUIREMENTS:**\nMust Have:\nNice to Have:\n**WHAT WE OFFER:**`,type:"text"},
{id:"meetingnotes",name:"AI Meeting Notes",icon:"📋",desc:"Turn raw notes into professional summaries",color:"#b45309",label:"Paste your meeting notes",ph:"e.g., 'Discussed Q2 targets, John handles marketing...'",tpl:["Board meeting","Client call summary","Team standup","Project kickoff"],pr:i=>`You are an executive assistant. Transform: "${i}"\n\n**📋 MEETING SUMMARY**\n**📌 KEY DECISIONS:**\n**✅ ACTION ITEMS:**\n| Action | Owner | Deadline |\n**📅 NEXT STEPS:**`,type:"text"},
{id:"spreadsheet",name:"AI Spreadsheet Helper",icon:"📈",desc:"Excel/Sheets formulas in plain English",color:"#16a34a",label:"What formula do you need?",ph:"e.g., 'Calculate 5% commission if sales > $10K'",tpl:["Sales commission","VLOOKUP help","Pivot table guide","Data cleaning"],pr:i=>`You are an Excel/Sheets expert. Help with: ${i}\n\n**📊 FORMULA:**\n\`\`\`excel\n[Formula]\n\`\`\`\n**📝 HOW IT WORKS:**\n**⚠️ COMMON ERRORS:**\n**💡 PRO TIPS:**`,type:"text"},
{id:"websitebuilder",name:"AI Website Builder",icon:"🖥️",desc:"Generate complete website code instantly",color:"#7c3aed",label:"Describe your website",ph:"e.g., 'Landing page for fitness coaching business'",tpl:["SaaS landing page","Portfolio website","Restaurant website","E-commerce homepage"],pr:i=>`You are a senior full-stack developer. Create complete website for: ${i}\n\nProvide: full HTML with embedded CSS and JS. Modern, responsive, professional design. Include all key sections.`,type:"text"},
...
{id:"pdfsummary",name:"AI Document Summarizer",icon:"📑",desc:"Summarize any text — extract key insights",color:"#dc2626",label:"Paste text to summarize",ph:"Paste your document, article, or report here...",tpl:["Research paper","Extract key points","Executive summary","Simplify legal doc"],pr:i=>`You are a senior analyst. Summarize: "${i}"\n\n**📌 ONE-LINE SUMMARY:**\n**📊 EXECUTIVE SUMMARY (100 words):**\n**🔑 KEY POINTS:**\n**📈 IMPORTANT DATA:**\n**💡 RECOMMENDATIONS:**`,type:"text"},
...
clrO();renderT();renderC();ucc();if(window.innerWidth<768)toggleSB()}
function clrO(){document.getElementById('oA').innerHTML='<div style="padding:50px 20px;text-align:center"><div style="font-size:42px;margin-bottom:12px;opacity:0.2">✨</div><div style="color:#475569;font-size:13px">Your AI content will appear here</div></div>';['cpB','dlB','clB'].forEach(id=>document.getElementById(id).style.display='none');co=''}
...
async function gen(){
  ...
  try{
    ...
    if(at.type==='image'||at.type==='upload'){
      ...
      ['cpB','dlB','clB'].forEach(id=>document.getElementById(id).style.display='');
    }
    if(window.trackUsage)window.trackUsage(at.type==='text'?2:(at.cost||10));
    // Save to library (Pro users only)
...
function dlO(){
  if(at.type==='image'||at.type==='upload'){
    ...
    const b=new Blob([co],{type:'text/plain'});const u=URL.createObjectURL(b);const a=document.createElement('a');a.href=u;a.download=at.name.replace(/\s+/g,'-').toLowerCase()+'-'+Date.now()+'.txt';a.click();URL.revokeObjectURL(u);
  }
}
