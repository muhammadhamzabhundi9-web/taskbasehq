    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, width: "100%", textAlign: "center", position: "relative" }}>
        ...
        <p style={{
          ...
          30+ Premium AI Tools — Image Generator, Video Creator, Voiceover AI, Content Writer & more.
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 8 }}>
            {[
              "🖼️ AI Images", "🎥 AI Videos", "🗣️ Voiceover AI", "📝 Content Writer",
              "✂️ BG Remover", "💻 Code Assistant", "📊 Presentations", "📱 Social Media",
              "🎵 Music Gen", "📄 PDF Tools", "🎬 Video Editor", "⌨️ Website Builder"
            ].map((t, i) => (
              <span key={i} style={{
                background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)",
