...
const PLANS = {
  free: { price: 0, label: "Free", period: "Free", features: ["All 45+ AI tools", "50 free credits", "Standard quality", "Email support", "No credit card"] },
  monthly: { price: 9.99, label: "$9.99", period: "/month", features: ["All 45+ AI tools", "Unlimited text generations", "AI image, video, voice tools", "4K HD exports", "Commercial license", "Priority support", "New tools monthly"] },
...
const TOOLS = [
  ...
  { id:3, name:"Background Remover", desc:"Remove backgrounds instantly. Perfect for product photos, profiles. AI-powered precision.", category:"image", icon:"✂️", marketPrice:15, features:["1-click removal","HD export","Custom BGs","Batch ready","API access"], badge:"⚡ Instant", trending:true, users:"42K+", rating:4.9 },
...
const FAQ = [
  { q:"What do I get?", a:"Unlimited access to ALL 45+ AI tools — image generator, video creator, voice cloner, content writer, code assistant, and more. One subscription, no hidden costs." },
  ...
  { q:"How is this so cheap?", a:"We bundle 45+ tools on optimized infrastructure. Others charge $20-80/month per tool. With TaskBase HQ you save $2,000+/month." },
    ...
    <nav style={{position:"sticky",top:0,zIndex:300,background:"rgba(6,8,16,0.92)",backdropFilter:"blur(20px)",borderBottom:`1px solid ${T.border}`}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",maxWidth:960,margin:"0 auto",padding:"0 16px",height:54}}>
        <div onClick={()=>go(PAGES.HOME)} style={{display:"flex",alignItems:"center",gap:9,cursor:"pointer"}}>
          ...
          <div><div style={{color:"#fff",fontSize:14,fontWeight:900,letterSpacing:-0.3,lineHeight:1}}>TaskBase HQ</div><div style={{color:T.cyan,fontSize:8,fontWeight:700,letterSpacing:1.5}}>45+ AI TOOLS • ONE PRICE</div></div>
        </div>
  ...
  return(<div>
    <section style={{padding:"44px 16px 36px",textAlign:"center",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",maxWidth:580,margin:"0 auto"}}>
        ...
        <h1 style={{color:"#fff",fontSize:"clamp(30px,7vw,48px)",fontWeight:900,lineHeight:1.1,margin:"18px 0 16px",letterSpacing:-1.5}}>45+ Premium AI Tools.<br/><span style={{background:`linear-gradient(135deg,${T.accent},${T.cyan})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>One Simple Price.</span></h1>
        ...
        <div style={{display:"flex",justifyContent:"center",gap:"clamp(16px,4vw,32px)",flexWrap:"wrap"}}>
          {[{v:"45+",l:"AI Tools"},{v:"50K+",l:"Users"},{v:"97%",l:"Savings"},{v:"4.8★",l:"Rating"}].map((s,i)=><div key={i}><div style={{color:T.accent,fontSize:22,fontWeight:900}}>{s.v}</div><div style={{color:T.dim,fontSize:10,fontWeight:600}}>{s.l}</div></div>)}
        </div>
      </div>
    </section>
    ...
    <section style={{padding:"30px 14px",maxWidth:960,margin:"0 auto"}}>
      ...
      <div style={{textAlign:"center",marginTop:20}}><button onClick={()=>go(PAGES.TOOLS)} style={{...bs(`${T.accent}15`),border:`1px solid ${T.accent}30`,padding:"12px 28px",fontSize:14,color:T.accent}}>View All 45+ AI Tools →</button></div>
    </section>
    <section style={{padding:"30px 14px",maxWidth:960,margin:"0 auto"}}>
...
function ToolsPage({go}){
  ...
  return(<div style={{maxWidth:960,margin:"0 auto",padding:"24px 14px"}}>
    ...
    <p style={{color:T.muted,fontSize:14,margin:"0 0 18px"}}>45+ premium tools — image, video, voice, writing, code & more</p>
...
function PricingPage(){
  ...
  return(<div style={{maxWidth:680,margin:"0 auto",padding:"32px 14px",textAlign:"center"}}>
    ...
    <p style={{color:T.muted,fontSize:15,margin:"0 0 28px"}}>All 45+ tools. Cancel anytime.</p>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:14,marginBottom:30,textAlign:"left"}}>
      ...
      <div style={{background:`${T.accent}08`,border:`2px solid ${T.accent}30`,borderRadius:18,padding:"24px 20px",position:"relative"}}>
        ...
        <p style={{color:T.muted,fontSize:12,margin:"0 0 18px"}}>Full access to all 45+ tools</p>
...
function TermsPage(){
  return(<div style={{maxWidth:700,margin:"0 auto",padding:"32px 14px"}}>
    ...
    <div style={{color:T.muted,fontSize:13,lineHeight:1.8}}>
      ...
      <p>TaskBase HQ provides subscription-based access to 45+ AI tools including image generation, video creation, voice cloning, content writing, code assistance, and more.</p>
