...
const SITE = {
  ...
  twitter: "@TaskBaseHQ",
  payMonthly: "https://hamzabhundi.gumroad.com/l/taskbasehq",
  payYearly: "https://hamzabhundi.gumroad.com/l/taskbasehq",
};
const PLANS = {
  free: { price: 0, label: "Free", period: "Free", features: ["All 40+ AI tools", "50 free credits", "Standard quality", "Email support", "No credit card"] },
  monthly: { price: 9.99, label: "$9.99", period: "/month", features: ["All 40+ AI tools", "Unlimited text generations", "AI image, video, voice tools", "4K HD exports", "Commercial license", "Priority support", "New tools monthly"] },
  yearly: { price: 79.99, label: "$79.99", period: "/year", features: ["Everything in Monthly", "Unlimited text generations", "AI image, video, voice tools", "4K HD exports", "Commercial license", "Priority support", "Early access to new tools", "Team sharing (up to 3)"] },
};
const CATEGORIES = [
...
const TOOLS = [
  { id:1, name:"AI Image Generator", desc:"Create stunning images from text. Photorealistic, anime, 3D — any style. Better than Midjourney at fraction of cost.", category:"image", icon:"🖼️", marketPrice:30, features:["Unlimited generations","4K resolution","100+ styles","Commercial license","Inpainting"], badge:"🔥 #1 Most Used", trending:true, users:"23K+", rating:4.9 },
  { id:2, name:"AI Video Creator", desc:"Turn text into pro videos. AI generates scenes, characters, voiceover — perfect for YouTube, TikTok, ads.", category:"video", icon:"🎥", marketPrice:76, features:["Text to video","AI characters","Auto voiceover","4K export","Green screen"], badge:"🚀 Viral Maker", trending:true, users:"18K+", rating:4.8 },
  { id:3, name:"AI Video Editor", desc:"Edit videos with text. Auto-cut highlights, remove silence, captions, transitions — zero skills needed.", category:"video", icon:"🎬", marketPrice:49, features:["Auto highlights","Silence removal","AI transitions","Auto captions","Color grading"], badge:"🎬 Pro Editor", trending:true, users:"31K+", rating:4.9 },
  { id:4, name:"AI Voiceover Generator", desc:"Pro voiceovers in 50+ languages. Natural AI voices for videos, podcasts, presentations.", category:"voice", icon:"🗣️", marketPrice:22, features:["50+ languages","Natural voices","Emotion control","Studio quality","Commercial"], badge:"🎯 Game Changer", trending:true, users:"15K+", rating:4.8 },
  { id:5, name:"AI Content Writer", desc:"Blog posts, articles, ad copy — anything. SEO optimized, plagiarism-free, 10x faster.", category:"writing", icon:"📝", marketPrice:49, features:["Blog & articles","Ad copy","SEO optimization","Plagiarism-free","30+ types"], badge:"✍️ Bestseller", trending:true, users:"27K+", rating:4.9 },
  { id:6, name:"Background Remover", desc:"Remove backgrounds instantly. Perfect for product photos, profiles. Bulk process 100s of images.", category:"image", icon:"✂️", marketPrice:15, features:["1-click removal","Bulk processing","Custom BGs","HD export","API access"], badge:"⚡ Instant", trending:true, users:"42K+", rating:4.9 },
  { id:7, name:"AI Music Generator", desc:"Royalty-free music for videos, podcasts, reels. Any genre, mood. Own everything.", category:"voice", icon:"🎵", marketPrice:25, features:["All genres","Royalty-free","Custom duration","Stems separation","Sound effects"], badge:"🎵 Creator Pick", users:"12K+", rating:4.7 },
  { id:8, name:"AI Code Assistant", desc:"Write, debug, generate code in 50+ languages. Full project scaffolding. Better than Copilot.", category:"code", icon:"⌨️", marketPrice:19, features:["50+ languages","Full project gen","Debug & fix","Code review","Unit tests"], badge:"💻 Dev Fav", trending:true, users:"14K+", rating:4.9 },
  ...
  { id:11, name:"AI Logo & Brand Kit", desc:"Pro logos, brand identity — colors, fonts, business cards, social media kit.", category:"business", icon:"💎", marketPrice:50, features:["Logo generator","Brand guidelines","Business cards","Social kit","Unlimited revisions"], badge:"🏆 Top Rated", users:"16K+", rating:4.8 },
  { id:12, name:"AI Social Manager", desc:"Posts, captions, hashtags for all platforms. Schedule, analyze, grow 10x.", category:"social", icon:"📱", marketPrice:29, features:["Multi-platform","Auto scheduling","AI captions","Analytics","Competitor tracking"], badge:"📱 All-in-One", trending:true, users:"22K+", rating:4.7 },
  { id:13, name:"AI Presentations", desc:"Describe topic, get stunning slideshow content. Auto-design, charts, speaker notes.", category:"business", icon:"📊", marketPrice:25, features:["Slide content","Charts","50+ templates","Speaker notes","Outline export"], badge:"📊 Office Must", trending:true, users:"11K+", rating:4.6 },
  { id:14, name:"AI Resume Builder", desc:"ATS-optimized resumes that get interviews. AI writes bullets, formats perfectly.", category:"writing", icon:"💼", marketPrice:12, features:["ATS optimized","AI bullets","25+ templates","Cover letters","LinkedIn optimizer"], badge:"💼 Land Jobs", trending:true, users:"35K+", rating:4.8 },
  { id:15, name:"AI Photo Editor", desc:"Edit photos with text. Remove objects, change BGs, adjust lighting — magic.", category:"image", icon:"🎨", marketPrice:20, features:["Text editing","Object removal","BG removal","Style transfer","Batch"], badge:"🪄 Magic Edit", users:"17K+", rating:4.7 },
  { id:16, name:"AI Grammar & Rewriter", desc:"Fix grammar, rewrite for any tone. Plagiarism check.", category:"writing", icon:"🔤", marketPrice:20, features:["Grammar fix","Tone adjust","Plagiarism check","Readability","Multi-lang"], badge:"✅ Write Better", trending:true, users:"24K+", rating:4.7 },
  { id:17, name:"AI Translator Pro", desc:"Translate text, documents, websites in 130+ languages. Preserves meaning and context.", category:"writing", icon:"🌐", marketPrice:15, features:["130+ languages","Context-aware","Documents","Websites","Bulk translate"], badge:"🌍 130+ Lang", trending:true, users:"19K+", rating:4.8 },
  { id:18, name:"AI Thumbnail Maker", desc:"Click-worthy YouTube thumbnails, social banners. AI picks best layouts.", category:"social", icon:"📺", marketPrice:12, features:["YouTube sized","Social sizes","AI layout","Brand templates","A/B test"], badge:"📈 Get Clicks", users:"21K+", rating:4.7 },
  { id:19, name:"AI Email Writer", desc:"Pro emails in seconds. Cold outreach, follow-ups, responses — perfect tone.", category:"productivity", icon:"📧", marketPrice:15, features:["Smart templates","Tone control","Follow-ups","Subject lines","Multi-lang"], badge:"📧 Save Hours", trending:true, users:"18K+", rating:4.6 },
  { id:20, name:"AI Website Builder", desc:"Describe your website, AI builds it. Landing pages, portfolios — responsive code.", category:"code", icon:"🌐", marketPrice:30, features:["AI builder","Responsive","SEO built-in","Templates","Custom code"], badge:"🔥 No-Code", users:"9K+", rating:4.7 },
  { id:21, name:"AI Meme & Reel Maker", desc:"Viral memes, reels, TikTok content. Trending templates, auto-captions.", category:"social", icon:"😂", marketPrice:10, features:["Trending templates","Auto captions","Viral formats","Direct sharing","Branding"], badge:"😂 Go Viral", trending:true, users:"28K+", rating:4.8 },
  { id:22, name:"AI Podcast Editor", desc:"Remove fillers, enhance audio, generate show notes, transcripts, clips.", category:"voice", icon:"🎧", marketPrice:25, features:["Filler removal","Audio enhance","Transcripts","Clip generator","Show notes"], badge:"🎙️ Podcast Pro", users:"7K+", rating:4.7 },
  { id:23, name:"AI Invoice & Finance", desc:"Pro invoices, expense tracking, auto-categorize transactions.", category:"business", icon:"🧾", marketPrice:18, features:["Invoices","Expense tracking","Auto categorize","Tax summaries","Client portal"], badge:"💰 Finance", users:"8K+", rating:4.6 },
  { id:24, name:"AI PDF Tool", desc:"Chat with PDFs, extract data, summarize, merge, split, fill forms.", category:"productivity", icon:"📄", marketPrice:15, features:["Chat with PDF","Data extraction","Summarize","Merge/split","Form fill"], badge:"📄 Doc Master", trending:true, users:"16K+", rating:4.7 },
  { id:25, name:"AI Meeting Notes", desc:"Perfect notes, action items, follow-up emails. Never miss details.", category:"productivity", icon:"📋", marketPrice:20, features:["Smart summaries","Action items","Follow-ups","Search","Key points"], badge:"📋 Never Forget", users:"10K+", rating:4.7 },
  { id:26, name:"AI Spreadsheets", desc:"Plain English formulas, analyze data, create charts, clean messy data.", category:"business", icon:"📈", marketPrice:15, features:["Formula writer","Data analysis","Auto charts","Data cleaning","Pivot tables"], badge:"📉 Data Pro", users:"13K+", rating:4.6 },
  { id:27, name:"AI SEO & Hashtags", desc:"Trending hashtags, SEO, keyword research, competitor analysis. Grow 10x.", category:"social", icon:"#️⃣", marketPrice:12, features:["Trending hashtags","SEO audits","Keywords","Competitors","Rank tracker"], badge:"📈 Rank Higher", trending:true, users:"15K+", rating:4.8 },
  { id:28, name:"AI Task Manager", desc:"AI auto-prioritizes tasks, suggests deadlines, tracks progress.", category:"productivity", icon:"✅", marketPrice:12, features:["AI priority","Smart deadlines","Progress tracking","Team boards","Integrations"], badge:"✅ Organize", users:"11K+", rating:4.6 },
  { id:29, name:"AI Face Swap", desc:"Swap faces in photos and videos instantly. Pro quality results.", category:"image", icon:"🎭", marketPrice:25, features:["Photo face swap","Video face swap","Batch processing","HD quality","Real-time"], badge:"🎭 Viral Tool", trending:true, users:"33K+", rating:4.8 },
  { id:30, name:"AI Docs Generator", desc:"Auto-generate API docs, READMEs, code comments, changelogs.", category:"code", icon:"📖", marketPrice:12, features:["API docs","README builder","Code comments","Changelog","OpenAPI"], badge:"📖 Auto Docs", users:"6K+", rating:4.6 },
  { id:31, name:"AI Voice Cloner", desc:"Clone any voice with 3 seconds of audio. Custom AI voices for content.", category:"voice", icon:"🎤", marketPrice:49, features:["3-sec cloning","Custom voices","100+ languages","Real-time","Commercial use"], badge:"🔥 Mind Blowing", trending:true, users:"9K+", rating:4.9 },
  { id:32, name:"AI Avatar Creator", desc:"Photorealistic AI avatars from text. Perfect for profiles, marketing.", category:"image", icon:"👤", marketPrice:20, features:["Photorealistic","100+ styles","Custom poses","HD download","Commercial"], badge:"👤 Go Digital", users:"11K+", rating:4.7 },
  { id:33, name:"AI Ad Creator", desc:"High-converting ads for Facebook, Google, Instagram — copy + creative.", category:"social", icon:"📢", marketPrice:35, features:["FB/IG/Google ads","Ad copy","Visual concepts","A/B variations","ROI focused"], badge:"💰 Convert More", users:"8K+", rating:4.7 },
  { id:34, name:"AI Business Plan", desc:"Investor-ready business plans in minutes. Market analysis, financial projections.", category:"business", icon:"📑", marketPrice:50, features:["Executive summary","Market analysis","Financial projections","Pitch deck","SWOT analysis"], badge:"📑 Investor Ready", users:"5K+", rating:4.7 },
  { id:35, name:"AI Chat Assistant", desc:"Smart AI chatbot like ChatGPT. Answers questions, writes content, helps with anything.", category:"productivity", icon:"💬", marketPrice:20, features:["Multi-turn chat","Code help","Research","Brainstorming","Always available"], badge:"🤖 24/7 Smart", trending:true, users:"40K+", rating:4.9 },
  { id:36, name:"AI Selfie to Headshot", desc:"Upload selfie, get professional LinkedIn-ready headshots in seconds. Replaces $300 photoshoots.", category:"image", icon:"🤳", marketPrice:30, features:["Pro headshots","20+ styles","HD download","LinkedIn ready","Background variants"], badge:"💼 Career Boost", trending:true, users:"25K+", rating:4.9 },
  { id:37, name:"AI Try-On Clothes", desc:"See yourself in any outfit before buying. Upload photo + clothing image, AI shows you wearing it.", category:"image", icon:"👗", marketPrice:20, features:["Virtual try-on","Any clothing","Realistic fit","Multiple angles","E-commerce ready"], badge:"👗 Try Before Buy", trending:true, users:"19K+", rating:4.8 },
  { id:38, name:"AI Song Generator", desc:"Write lyrics, AI creates full song with vocals. Any genre, any style. Replaces Suno AI.", category:"voice", icon:"🎤", marketPrice:10, features:["Full song generation","AI vocals","All genres","Custom lyrics","Commercial use"], badge:"🎤 Make Hits", trending:true, users:"22K+", rating:4.8 },
  { id:39, name:"AI Product Photography", desc:"Turn phone photos into pro studio shots. Perfect for Amazon, Shopify, e-commerce sellers.", category:"image", icon:"📸", marketPrice:39, features:["Studio quality","Multiple angles","Custom backgrounds","Bulk processing","E-commerce ready"], badge:"📸 Sell More", trending:true, users:"14K+", rating:4.8 },
  { id:40, name:"AI Talking Avatar", desc:"Upload photo + write script, AI makes the photo talk on video. Replaces HeyGen.", category:"video", icon:"🎬", marketPrice:30, features:["Photo to video","100+ languages","Custom scripts","Lip sync","Commercial license"], badge:"🎬 Magic Video", trending:true, users:"17K+", rating:4.8 },
];
const REVIEWS = [
...
const FAQ = [
  { q:"What do I get?", a:"Unlimited access to ALL 40+ AI tools — image generator, video creator, voice cloner, content writer, code assistant, and more. One subscription, no hidden costs." },
  ...
  { q:"How is this so cheap?", a:"We bundle 40+ tools on optimized infrastructure. Others charge $20-80/month per tool. With TaskBase HQ you save $2,000+/month." },
  { q:"Can I cancel anytime?", a:"Yes. One-click cancel from Gumroad. No contracts, no hidden fees. 30-day money-back guarantee." },
  ...
  { q:"Works on mobile?", a:"Yes! Any browser. Install as PWA app on home screen — works like native app." },
    ...
    <nav style={{position:"sticky",top:0,zIndex:300,background:"rgba(6,8,16,0.92)",backdropFilter:"blur(20px)",borderBottom:`1px solid ${T.border}`}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",maxWidth:960,margin:"0 auto",padding:"0 16px",height:54}}>
        <div onClick={()=>go(PAGES.HOME)} style={{display:"flex",alignItems:"center",gap:9,cursor:"pointer"}}>
          ...
          <div><div style={{color:"#fff",fontSize:14,fontWeight:900,letterSpacing:-0.3,lineHeight:1}}>TaskBase HQ</div><div style={{color:T.cyan,fontSize:8,fontWeight:700,letterSpacing:1.5}}>40+ AI TOOLS • ONE PRICE</div></div>
        </div>
  ...
  return(
    <div onClick={onClose} style={{position:"fixed",inset:0,zIndex:500,background:"rgba(0,0,0,0.85)",backdropFilter:"blur(10px)",display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
      <div onClick={e=>e.stopPropagation()} style={{background:`linear-gradient(180deg,#111827 0%,${T.bg} 100%)`,borderRadius:"22px 22px 0 0",width:"100%",maxWidth:460,maxHeight:"82vh",overflowY:"auto",padding:"20px 18px 30px",animation:"modalUp 0.3s cubic-bezier(0.16,1,0.3,1)"}}>
        ...
        <button onClick={()=>{onClose();go(PAGES.PRICING);}} style={{...bs(`linear-gradient(135deg,${T.accent},${T.cyan})`,`0 8px 25px ${T.accentGlow}`),width:"100%",padding:15,fontSize:15}}>Get 50 Free Credits →</button>
  ...
  return(<div>
    <section style={{padding:"44px 16px 36px",textAlign:"center",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",maxWidth:580,margin:"0 auto"}}>
        ...
        <h1 style={{color:"#fff",fontSize:"clamp(30px,7vw,48px)",fontWeight:900,lineHeight:1.1,margin:"18px 0 16px",letterSpacing:-1.5}}>40+ Premium AI Tools.<br/><span style={{background:`linear-gradient(135deg,${T.accent},${T.cyan})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>One Simple Price.</span></h1>
        ...
        <div style={{display:"flex",justifyContent:"center",gap:"clamp(16px,4vw,32px)",flexWrap:"wrap"}}>
          {[{v:"40+",l:"AI Tools"},{v:"50K+",l:"Users"},{v:"97%",l:"Savings"},{v:"4.8★",l:"Rating"}].map((s,i)=><div key={i}><div style={{color:T.accent,fontSize:22,fontWeight:900}}>{s.v}</div><div style={{color:T.dim,fontSize:10,fontWeight:600}}>{s.l}</div></div>)}
        </div>
      </div>
    </section>
    ...
    <section style={{padding:"30px 14px",maxWidth:960,margin:"0 auto"}}>
      ...
      <div style={{textAlign:"center",marginTop:20}}><button onClick={()=>go(PAGES.TOOLS)} style={{...bs(`${T.accent}15`),border:`1px solid ${T.accent}30`,padding:"12px 28px",fontSize:14,color:T.accent}}>View All 40+ AI Tools →</button></div>
    </section>
    <section style={{padding:"30px 14px",maxWidth:960,margin:"0 auto"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))",gap:12}}>
        {[{icon:"💸",title:"Save $2,000+/Month",desc:"Replace 15+ subscriptions with one simple price."},{icon:"⚡",title:"Unlimited Generations",desc:"No caps on text tools. Reasonable limits on image/video/voice."},{icon:"🆕",title:"New Tools Monthly",desc:"2-3 new tools every month. All free with your plan."},{icon:"📱",title:"Works Everywhere",desc:"Desktop, mobile, tablet. Install as app on home screen."},{icon:"🔒",title:"50 Free Credits",desc:"Start free with 50 credits. No credit card needed."},{icon:"🏆",title:"Commercial License",desc:"Everything you create is yours. Use for anything."}].map((v,i)=>
...
function ToolsPage({go}){
  ...
  return(<div style={{maxWidth:960,margin:"0 auto",padding:"24px 14px"}}>
    ...
    <p style={{color:T.muted,fontSize:14,margin:"0 0 18px"}}>40+ premium tools — image, video, voice, writing, code & more</p>
...
function PricingPage(){
  ...
  return(<div style={{maxWidth:680,margin:"0 auto",padding:"32px 14px",textAlign:"center"}}>
    ...
    <p style={{color:T.muted,fontSize:15,margin:"0 0 28px"}}>All 40+ tools. Cancel anytime.</p>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:14,marginBottom:30,textAlign:"left"}}>
      ...
      <div style={{background:`${T.accent}08`,border:`2px solid ${T.accent}30`,borderRadius:18,padding:"24px 20px",position:"relative"}}>
        ...
        <p style={{color:T.muted,fontSize:12,margin:"0 0 18px"}}>Full access to all 40+ tools</p>
        ...
        <button onClick={()=>window.open(plan==="monthly"?SITE.payMonthly:SITE.payYearly,'_blank')} style={{...bs(`linear-gradient(135deg,${T.accent},${T.cyan})`,`0 8px 25px ${T.accentGlow}`),width:"100%",padding:14,fontSize:15,marginTop:16}}>🚀 Get {PLANS[plan].label}{PLANS[plan].period}</button>
...
function TermsPage(){
  return(<div style={{maxWidth:700,margin:"0 auto",padding:"32px 14px"}}>
    ...
    <div style={{color:T.muted,fontSize:13,lineHeight:1.8}}>
      ...
      <p>TaskBase HQ provides subscription-based access to 40+ AI tools including image generation, video creation, voice cloning, content writing, code assistance, and more.</p>
      <h3 style={{color:T.text,marginTop:20}}>2. Subscription Plans</h3>
      <p>Monthly ($9.99/month) and Yearly ($79.99/year) plans. New users get 50 free credits. Cancel anytime.</p>
...
function RefundPage(){
  return(<div style={{maxWidth:700,margin:"0 auto",padding:"32px 14px"}}>
    ...
    <div style={{color:T.muted,fontSize:13,lineHeight:1.8}}>
      <p><strong style={{color:T.text}}>Last updated:</strong> April 2026</p>
      <p>We want you completely satisfied with TaskBase HQ.</p>
      <h3 style={{color:T.text,marginTop:20}}>1. 50 Free Credits</h3>
      <p>All plans include 50 free credits. Test before subscribing.</p>
      <h3 style={{color:T.text,marginTop:20}}>2. 30-Day Money-Back Guarantee</h3>
      <p>Full refund within 30 days of first payment. No questions asked.</p>
      <h3 style={{color:T.text,marginTop:20}}>3. How to Request</h3>
      <p>Email {SITE.email} or WhatsApp {SITE.whatsappDisplay}. Processed within 5-10 business days.</p>
      <h3 style={{color:T.text,marginTop:20}}>4. Cancellation</h3>
      <p>Cancel anytime from Gumroad. Access continues until billing period ends.</p>
      <h3 style={{color:T.text,marginTop:20}}>5. Contact</h3>
      <p>Email {SITE.email} or WhatsApp {SITE.whatsappDisplay}.</p>
    </div>
  </div>);
}
