...
const PLANS = {
  free: { price: 0, label: "Free", period: "Free", features: ["All 30+ AI tools", "50 free credits", "Standard quality", "Email support", "No credit card"] },
  monthly: { price: 9.99, label: "$9.99", period: "/month", features: ["All 30+ AI tools", "Unlimited text generations", "AI image, video, voice tools", "4K HD exports", "Commercial license", "Priority support", "New tools monthly"] },
...
const FAQ = [
  { q:"What do I get?", a:"Unlimited access to ALL 30+ AI tools — image generator, video creator, voice cloner, content writer, code assistant, and more. One subscription, no hidden costs." },
  ...
  { q:"How is this so cheap?", a:"We bundle 30+ tools on optimized infrastructure. Others charge $20-80/month per tool. With TaskBase HQ you save $2,000+/month." },
...
function ToolsPage({go}){
  ...
  return(<div style={{maxWidth:960,margin:"0 auto",padding:"24px 14px"}}>
    ...
    <p style={{color:T.muted,fontSize:14,margin:"0 0 18px"}}>30+ premium tools — image, video, voice, writing, code & more</p>
  ...
  return(<div style={{maxWidth:680,margin:"0 auto",padding:"32px 14px",textAlign:"center"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:14,marginBottom:30,textAlign:"left"}}>
      ...
      <div style={{background:`${T.accent}08`,border:`2px solid ${T.accent}30`,borderRadius:18,padding:"24px 20px",position:"relative"}}>
        ...
        <p style={{color:T.muted,fontSize:12,margin:"0 0 18px"}}>Full access to all 30+ tools</p>
...
function TermsPage(){
  return(<div style={{maxWidth:700,margin:"0 auto",padding:"32px 14px"}}>
    ...
    <div style={{color:T.muted,fontSize:13,lineHeight:1.8}}>
      ...
      <p>TaskBase HQ provides subscription-based access to 30+ AI tools including image generation, video creation, voice cloning, content writing, code assistance, and more.</p>
