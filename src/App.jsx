...
const PLANS = {
  ...
  monthly: { price: 9.99, label: "$9.99", period: "/month", features: ["500 credits/month", "46+ AI tools", "Standard image quality", "Vision AI Chat (1 file/msg)", "Pro Library", "PDF/Word/Excel export", "Email support"] },
  yearly: { price: 79.99, label: "$79.99", period: "/year", features: ["500 credits/month", "Save 33% vs monthly", "All Pro Monthly features", "Standard image quality", "Vision AI Chat", "Pro Library"] },
  proplus: { price: 19.99, label: "$19.99", period: "/month", features: ["1,500 credits/month (3x)", "🎨 HD Image Quality (2048px)", "🤖 Vision AI: 5 files/msg", "⚡ Priority generation queue", "💼 Commercial license", "📞 WhatsApp support", "All Pro features"] },
  proplusyearly: { price: 199.99, label: "$199.99", period: "/year", features: ["1,500 credits/month", "Save 17% vs monthly", "🎨 HD Image Quality", "🤖 5 files/msg in Vision AI", "⚡ Priority queue", "💼 Commercial license"] },
  promax: { price: 39.99, label: "$39.99", period: "/month", features: ["5,000 credits/month (10x)", "🚀 4K Ultra Image Quality", "🤖 Vision AI: Unlimited files", "⚡ Fastest generation", "🎁 No watermark on exports", "📞 24/7 WhatsApp support", "🎯 1-on-1 setup call", "All Pro Plus features"] },
  promaxyearly: { price: 399.99, label: "$399.99", period: "/year", features: ["5,000 credits/month", "Save 17% vs monthly", "🚀 4K Ultra Quality", "🤖 Unlimited Vision AI files", "🎁 No watermark", "📞 24/7 WhatsApp support"] },
};
const CATEGORIES = [
