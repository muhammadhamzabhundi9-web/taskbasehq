...
const PLANS = {
  ...
  promax: { price: 39.99, label: "$39.99", period: "/month", features: ["5,000 credits/month", "10x more than Pro", "All Pro Plus features", "WhatsApp 24/7 support", "1-on-1 setup call", "Early access to new tools"] },
  promaxyearly: { price: 399.99, label: "$399.99", period: "/year", features: ["5,000 credits/month", "Save 17% vs monthly", "All Pro Max features", "WhatsApp 24/7 support", "1-on-1 setup call"] },
};
const CATEGORIES = [
